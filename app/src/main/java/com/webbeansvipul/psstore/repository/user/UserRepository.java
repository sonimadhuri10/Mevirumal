package com.webbeansvipul.psstore.repository.user;
...
public class UserRepository extends PSRepository{
     ...
     */
    public LiveData<Resource<UserLogin>> doLogin(String apiKey, String email, String password, String referral_code) {
        ...
        return new NetworkBoundResource<UserLogin, User>(appExecutors) {
            ...
            protected LiveData<ApiResponse<User>> createCall() {
                ...
                return psApiService.postUserLogin(apiKey, email, password,referral_code);
            }
...
//                        userId = item.userId;
     ...
     * @return Login User Data
     */
    public LiveData<Resource<User>> registerUser(String apiKey,String loginUserId, String userName, String email, String password,String phone, String deviceToken,String referral_code) {
        ...
        try {
            ...
            Response<User> response = psApiService.postUser(apiKey,Utils.checkUserId(loginUserId), userName, email, password,phone,deviceToken,referral_code).execute();
...
//                    }
    ...
    public LiveData<Resource<UserLogin>> postPhoneLogin(String apiKey, String phoneId, String userName, String userPhone, String deviceToken, String referalCode) {
        ...
        appExecutors.networkIO().execute(() -> {
            ...
            try {
                ...
                // Call the API Service
                Response<User> response = psApiService
                        .postPhoneLogin(apiKey, phoneId, userName, userPhone, deviceToken, referalCode).execute();
