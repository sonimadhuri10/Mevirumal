...
public class DrApponimetAdapter extends RecyclerView.Adapter<DrApponimetAdapter.MyViewHolder> {
    ArrayList<LabModel.labtestlist> al;
    Context context;

    public DrApponimetAdapter(ArrayList<LabModel.labtestlist> al, Context context) {
        this.al = al;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(context,BookAppoinment.class);
