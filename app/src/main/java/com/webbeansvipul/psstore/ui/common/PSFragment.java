...
import com.webbeansvipul.psstore.di.Injectable;
...
public abstract class PSFragment extends Fragment implements Injectable {
    ...
    protected String cod, paypal, stripe, messenger, whatsappNo,razorpay;
    ...
    protected void loadLoginUserId() {
        try {
            ...
            if (getActivity() != null && getActivity().getBaseContext() != null) {
                ...
                razorpay = pref.getString(Constants.PAYMENT_RAZORPAY, Constants.ZERO);
