package com.webbeansvipul.psstore.ui.product.filtering.adapter;
...
import com.webbeansvipul.psstore.databinding.ItemCategoryFilterBinding;
import com.webbeansvipul.psstore.databinding.ItemSubCategoryFilterBinding;
import com.webbeansvipul.psstore.ui.product.filtering.Grouping;
...
public class CategoryAdapter extends BaseExpandableListAdapter {
    ...
    public CategoryAdapter(androidx.databinding.DataBindingComponent dataBindingComponent,
                           filteringClickCallback callback, String catId, String subCatId , String subcatname) {
    ...
    public View getChildView(int i, int childPosition, boolean b, View view, ViewGroup viewGroup) {
        ...
        subCategoryItemBinding.getRoot().setOnClickListener(view1 -> {
            ...
            callback.onClick(catId, subCatId , subcatname);
    ...
    public interface filteringClickCallback {
        void onClick(String catId, String subCatId , String subcatname);
    }
