package com.webbeansvipul.psstore.ui.user.phonelogin;
...
import com.webbeansvipul.psstore.databinding.FragmentPhoneLoginBinding;
...
public class PhoneLoginFragment extends PSFragment {
    ...
    private String number, userName, referalCode;
...
//            ((MainActivity) getActivity()).refreshPSCount();
        ...
        binding.get().addPhoneButton.setOnClickListener(v -> {
            if ( binding.get().nameEditText.getText().toString().trim().isEmpty()) {
                ...
                number = "+91"+binding.get().phoneEditText.getText().toString();
                userName = binding.get().nameEditText.getText().toString();
                referalCode = binding.get().referalEditText.getText().toString();
                PhoneLoginFragment.this.validNo(number);

                Utils.navigateAfterPhoneVerify(getActivity(),navigationController,number,userName,referalCode);
