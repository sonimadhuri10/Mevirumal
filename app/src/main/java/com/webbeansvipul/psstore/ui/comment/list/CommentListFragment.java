...
import com.webbeansvipul.psstore.databinding.FragmentCommentListBinding;
import com.webbeansvipul.psstore.ui.comment.list.adapter.CommentListAdapter;
...
public class CommentListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<com.webbeansvipul.psstore.viewobject.Comment>>> news = commentListViewModel.getCommentListData();
    ...
    private void replaceData(List<com.webbeansvipul.psstore.viewobject.Comment> commentList) {
