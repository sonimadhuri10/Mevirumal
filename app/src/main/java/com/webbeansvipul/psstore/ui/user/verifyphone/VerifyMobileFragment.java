package com.webbeansvipul.psstore.ui.user.verifyphone;
...
import com.webbeansvipul.psstore.databinding.FragmentVerifyMobileBinding;
...
public class VerifyMobileFragment extends PSFragment {
    ...
    private String userPhoneNo, userName, phoneUserId, token, referalCode;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (getActivity() != null && getActivity().getIntent() != null) {
            ...
            if (getArguments() != null) {
                ...
                referalCode = getArguments().getString(Constants.REFERAL_CODE);
            }
                        ...
                        if (task.isSuccessful()) {
                            try {
                                ...
                                if (task.getResult() != null && task.getResult().getUser() != null) {
                                    ...
                                    userViewModel.setPhoneLoginUser(phoneUserId, userName, userPhoneNo, token, referalCode);
                                }
                            } catch (Exception e1) {
