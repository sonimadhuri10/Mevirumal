...
import com.webbeansvipul.psstore.databinding.FragmentCommentDetailBinding;
import com.webbeansvipul.psstore.ui.comment.detail.adapter.CommentDetailAdapter;
...
public class CommentDetailFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.webbeansvipul.psstore.viewobject.CommentDetail> commentList) {
