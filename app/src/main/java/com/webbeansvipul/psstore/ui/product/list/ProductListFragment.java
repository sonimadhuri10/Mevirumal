package com.webbeansvipul.psstore.ui.product.list;
...
import com.webbeansvipul.psstore.databinding.BottomBoxLayoutBinding;
import com.webbeansvipul.psstore.databinding.FragmentProductListBinding;
import com.webbeansvipul.psstore.ui.common.DataBoundListAdapter;
import com.webbeansvipul.psstore.ui.common.PSFragment;
import com.webbeansvipul.psstore.ui.product.adapter.ProductVerticalListAdapter;
...
public class ProductListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE__PRODUCT_LIST_FRAGMENT
            ...
            String subcatname = data.getStringExtra(Constants.SUBCATEGORY_NAME);


            if(subcatname != null){
                binding.get().tvsubcategoryname.setVisibility(View.VISIBLE);
                binding.get().tvsubcategoryname.setText("Filter With - "+subcatname);
            }else{
                binding.get().tvsubcategoryname.setVisibility(View.GONE);
            }
