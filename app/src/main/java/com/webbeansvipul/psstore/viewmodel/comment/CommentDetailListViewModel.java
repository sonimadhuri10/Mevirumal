package com.webbeansvipul.psstore.viewmodel.comment;

import com.webbeansvipul.psstore.Config;
import com.webbeansvipul.psstore.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.webbeansvipul.psstore.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.webbeansvipul.psstore.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.webbeansvipul.psstore.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();
