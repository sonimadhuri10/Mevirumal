...
import com.webbeansvipul.psstore.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.webbeansvipul.psstore.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.webbeansvipul.psstore.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.webbeansvipul.psstore.viewmodel.comment.CommentListViewModel.TmpDataHolder();
