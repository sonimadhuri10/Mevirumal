package com.webbeansvipul.psstore.viewmodel.user;
...
import com.webbeansvipul.psstore.repository.user.UserRepository;
...
public class UserViewModel extends ViewModel {
    ...
    public UserViewModel(UserRepository repository) {
        ...
        doUserLoginData = Transformations.switchMap(doUserLoginObj, obj -> {
            ...
            return repository.doLogin(Config.API_KEY, obj.userEmail, obj.userPassword, obj.referral_code);
        });
        ...
        registerUserData = Transformations.switchMap(registerUserObj, obj -> {
            ...
            return repository.registerUser(Config.API_KEY, obj.user.userId, obj.user.userName, obj.user.userEmail, obj.user.userPassword, obj.user.userPhone,obj.user.deviceToken,obj.user.referral_code);
        });
        ...
        phoneLoginData = Transformations.switchMap(phoneLoginObj, obj -> {
            ...
            return repository.postPhoneLogin(Config.API_KEY, obj.phoneId, obj.name, obj.phone, obj.deviceToken, obj.referalCode);
        });
    }
...
//    }
    ...
    // phone login User
    public void setPhoneLoginUser(String phoneId, String name, String phone, String deviceToken, String referalCode) {
        TmpDataHolder tmpDataHolder = new TmpDataHolder();
        tmpDataHolder.phoneId = phoneId;
        tmpDataHolder.name = name;
        tmpDataHolder.phone = phone;
        tmpDataHolder.deviceToken = deviceToken;
        tmpDataHolder.referalCode = referalCode;
